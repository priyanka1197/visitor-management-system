...
def checkout(request):
    if request.method == 'GET':
        ...
        Subject = "Visitors meeting details"
        visitor = meeting
...
def sendsms(subject,visitor,host):
    ...
    ## FILL IN YOUR DETAILS HERE
    req_params = {
    'authorization':'wESYX0Ihv8o21fl7a4pRmGiANOBcUxrQ3sT6uzj5WtkDJeyHqdYaPx37G2fBQJiuFtvcnDrM4mWlbKeC',
    'sender_id':'FSTSMS',
    'message':msg,
    'language':'english',
    'number': '+91'+str(host.host_phone),
    }
